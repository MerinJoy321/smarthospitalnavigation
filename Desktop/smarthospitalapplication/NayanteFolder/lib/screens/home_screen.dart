  ...
  void _startNavigation() {
    if (_start == null || _destination == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Please select a start point and a destination.',
    ...
    // Use multi-floor routing (always starts on Ground Floor)
    final multiFloorRoute = widget.routingService.findMultiFloorRoute(
      start: _start!,
    ...
    if (multiFloorRoute == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'No route found. Please try a different destination.',
            style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w500),
          ),
          behavior: SnackBarBehavior.floating,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        ...
        title: Row(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.medical_services_rounded, size: 20, color: Colors.white),
            ),
